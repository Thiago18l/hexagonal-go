...
// IsValidPosition returns true if the given position is within the range of the board;
func (board Board) IsValidPosition(pos Position) bool {
	return pos.Row >= 0 && pos.Column >= 0 && pos.Row < len(board) && pos.Column < len(board[0])
}

// GetNeighborsIfNoBombs given the neighbors of given position
...
// Count returns the count of the elements of given type
